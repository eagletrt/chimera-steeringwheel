...
class CarStatus : public QObject {
  ...
  Q_PROPERTY(int ecuControl READ ecuControl NOTIFY ecuControlChanged)
  ...
  Q_PROPERTY(bool telemetryStatus READ telemetryStatus NOTIFY telemetryStatusChanged)
...
public:
  ...
  const int LOOP_THROUGH_ECU_CONTROLS = -1;
